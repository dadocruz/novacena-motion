...
ARG NEXT_PUBLIC_MOTION_META_PIXEL_ID=
ARG NEXT_PUBLIC_MOTION_GTM_ID=
ARG NEXT_PUBLIC_MOTION_GA_ID=
ARG NEXT_PUBLIC_MOTION_GOOGLE_ADS_ID=
ENV NEXT_PUBLIC_MOTION_META_PIXEL_ID=$NEXT_PUBLIC_MOTION_META_PIXEL_ID
ENV NEXT_PUBLIC_MOTION_GTM_ID=$NEXT_PUBLIC_MOTION_GTM_ID
ENV NEXT_PUBLIC_MOTION_GA_ID=$NEXT_PUBLIC_MOTION_GA_ID
ENV NEXT_PUBLIC_MOTION_GOOGLE_ADS_ID=$NEXT_PUBLIC_MOTION_GOOGLE_ADS_ID
