...
import { resolveMotion, ff } from '../lib/fontCatalog';
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div
            style={{
              ...
              letterSpacing: -6,
              color: '#fff',
              textShadow: `0 14px 50px rgba(0,0,0,0.92), 0 0 ${30 + numberGlow * 60}px rgba(60,220,130,${0.3 + numberGlow * 0.4})`,
              overflow: 'visible',
        ...
        >
          <PlatformLogo name="Spotify" size={84} />
        </div>
      </AbsoluteFill>
