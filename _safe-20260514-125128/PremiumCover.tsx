...
export const PremiumCover: React.FC<Props> = ({
  ...
  if (typeof window !== "undefined" && frame === 0) console.log("[PremiumCover] motionId=", motionId, "id=", id);
  ...
  const opacity = eased(frame, entryFrame, entryFrame + 12, easings.outCubic);
